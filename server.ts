...
import stripeRoutes from "./routers/stripeRoutes";
...
const usersController = new UsersController(new UsersService(UserModel));

const stripeController = new StripeController(new StripeService(stripe));
